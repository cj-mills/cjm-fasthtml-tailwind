...
def size(
    w:Union=None, # Width value
    h:Union=None, # Height value
    min_w:Union=None, # Minimum width
    max_w:Union=None, # Maximum width
    min_h:Union=None, # Minimum height
    max_h:Union=None, # Maximum height
...
def square(
    size:Union, # Size value for both width and height
