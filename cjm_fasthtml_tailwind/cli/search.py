...
# %% ../../nbs/cli/search.ipynb #45b29122-5339-48c7-912d-56b950d6a3a6
...
# %% ../../nbs/cli/search.ipynb #5def1b29-4967-4ca8-abd0-224d4c9fe5dd
...
# %% ../../nbs/cli/search.ipynb #ec1c522f-2540-4c68-a533-47981749dd3c
def search_examples(
    query: str,  # Search query
    include_source: bool = False,  # Whether to search in source code
    case_sensitive: bool = False  # Whether to perform case-sensitive search
...
# %% ../../nbs/cli/search.ipynb #db87b1a8-8b57-48ad-a54c-bf6f04abadea
def search_helpers(
    query: str,  # Search query
    include_source: bool = False,  # Whether to search in source code
    case_sensitive: bool = False  # Whether to perform case-sensitive search
...
# %% ../../nbs/cli/search.ipynb #0b90b30c-1cc4-46cf-8b71-81eb49497da4
def search_modules(
    query: str,  # Search query
    case_sensitive: bool = False  # Whether to perform case-sensitive search
) -> List[SearchResult]:  # List of search results
...
# %% ../../nbs/cli/search.ipynb #73e60624-e472-486f-bd5e-9ce8693876eb
def search_all(
    query: str,  # Search query
