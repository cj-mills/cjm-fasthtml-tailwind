...
# %% ../../nbs/utilities/transforms.ipynb #ca24533d-dfc1-453f-89dd-91a5510ee62f
...
# %% ../../nbs/utilities/transforms.ipynb #b0223098-0714-4567-8470-aa5658af92f6
...
# %% ../../nbs/utilities/transforms.ipynb #4b32704a-c66d-4f82-a612-078b31d93924
...
# %% ../../nbs/utilities/transforms.ipynb #22aeed80-3a54-43c2-8e00-f031fd3cf7e8
...
# %% ../../nbs/utilities/transforms.ipynb #d5525519-9c95-4a76-ab28-3e80ec169fd4
...
# %% ../../nbs/utilities/transforms.ipynb #ad653a8a-00db-488e-a137-f390e99cd33f
...
# %% ../../nbs/utilities/transforms.ipynb #da5f52ee-a5b5-4ddb-bdf5-60ad8bdeeaad
...
# %% ../../nbs/utilities/transforms.ipynb #bb904839-4e55-4985-971e-b768fe6b2a27
...
# %% ../../nbs/utilities/transforms.ipynb #69e3d8a2-e5b2-47e7-b527-ed6967d1cddb
...
# %% ../../nbs/utilities/transforms.ipynb #40c03bcd-3858-4035-8b01-1f74dc54ef4a
...
# %% ../../nbs/utilities/transforms.ipynb #65305431-26f3-4ab0-9e36-8744b41cad56
...
# %% ../../nbs/utilities/transforms.ipynb #5c2d6a32-616f-459b-90a4-65500e174eed
# Rotate angle values
...
# %% ../../nbs/utilities/transforms.ipynb #215ae315-8797-4398-a231-6bfbf654e9a0
...
# %% ../../nbs/utilities/transforms.ipynb #acb35d9c-ca01-41dd-8a18-892e33288ff2
...
# %% ../../nbs/utilities/transforms.ipynb #ee40d176-02a5-4c04-ac41-8ef5b8a6261e
...
# %% ../../nbs/utilities/transforms.ipynb #c0974ee6-ca82-40bc-b36b-57d811a1c8dc
rotate = RotateFactory() # The rotate factory

# %% ../../nbs/utilities/transforms.ipynb #2928e219-5122-463f-879b-9a000525d629
...
# %% ../../nbs/utilities/transforms.ipynb #103002a9-44e0-4162-b0ed-cac83f8e717b
...
# %% ../../nbs/utilities/transforms.ipynb #beb6d2e2-8082-4502-8752-a9c2b6ced2dc
...
# %% ../../nbs/utilities/transforms.ipynb #b5a9c4ce-bd8f-451a-add5-820f76a3f1e6
...
# %% ../../nbs/utilities/transforms.ipynb #26cb7074-f491-480b-a0ce-7e3c86c19755
...
# %% ../../nbs/utilities/transforms.ipynb #eee6ca14-f095-4106-9cce-1fa5e917263d
scale_tw = ScaleFactory() # The scale factory (renamed to avoid conflict with built-in scale)

# %% ../../nbs/utilities/transforms.ipynb #18dd0759-4480-4e93-b7ee-cf6f9cfd8824
...
# %% ../../nbs/utilities/transforms.ipynb #77b7e249-6466-40bc-a9d9-d7d5f736886e
# Skew angle values
SKEW_ANGLES = [0, 1, 2, 3, 6, 12] # Common skew angles in degrees

# %% ../../nbs/utilities/transforms.ipynb #993ab7f6-3771-416d-b892-0f9ac33bcf6e
...
# %% ../../nbs/utilities/transforms.ipynb #aa0ad9aa-17ee-4ff0-9a95-f13e6e365b7e
...
# %% ../../nbs/utilities/transforms.ipynb #4cd72f14-7563-4317-8149-a603f8d220d6
...
# %% ../../nbs/utilities/transforms.ipynb #38e90bfc-d0b0-4057-9ff3-b36a933c8e5f
skew = SkewFactory() # The skew factory

# %% ../../nbs/utilities/transforms.ipynb #208d80a4-d7de-4686-9102-f9f8345901c0
...
# %% ../../nbs/utilities/transforms.ipynb #70491dd6-590c-4fe8-a430-40a1ab608573
# Transform utilities
TRANSFORM_VALUES = {
    "none": "transform-none",
    "gpu": "transform-gpu",
...
# %% ../../nbs/utilities/transforms.ipynb #4e5982e4-38c4-460f-9578-4543986ea700
...
# %% ../../nbs/utilities/transforms.ipynb #c31071cb-af4e-4842-aaa8-d17cea89b692
transform = TransformFactory(TRANSFORM_VALUES, "Transform utilities for transforming elements") # The transform factory

# %% ../../nbs/utilities/transforms.ipynb #c52c5381-1083-499e-9078-d84e1494260c
...
# %% ../../nbs/utilities/transforms.ipynb #e30579c2-b838-48e7-be84-f372cd27159a
...
# %% ../../nbs/utilities/transforms.ipynb #9114e368-9092-443f-b875-c4d54e2c927e
# Enhanced factory that supports both fixed values and custom positions
...
# %% ../../nbs/utilities/transforms.ipynb #553aab3f-dbd4-49c4-9dfe-35c9c768d40c
...
# %% ../../nbs/utilities/transforms.ipynb #92b5dd30-3914-4f7c-9266-462d6e7a9547
...
# %% ../../nbs/utilities/transforms.ipynb #ce8635c2-82fd-4300-88df-e31393482b99
...
# %% ../../nbs/utilities/transforms.ipynb #b7266682-9b8b-44d8-8f81-e5c6ee9b1ff5
...
# %% ../../nbs/utilities/transforms.ipynb #09c7b57e-09b5-44ef-9866-e0f850ed70e9
...
# %% ../../nbs/utilities/transforms.ipynb #d5c98fbb-f7db-4e8b-81d1-f140931f2ad4
...
# %% ../../nbs/utilities/transforms.ipynb #a5cc661d-5b51-4bf5-bf7a-0319e3409364
translate = TranslateFactory() # The translate factory

# %% ../../nbs/utilities/transforms.ipynb #598ed6e8-25de-4162-a550-2338cc6e587b
...
# %% ../../nbs/utilities/transforms.ipynb #7d89e015-6031-4e2d-9ccd-2f72138510f6
...
# %% ../../nbs/utilities/transforms.ipynb #2e981087-e885-4a26-a9f1-2cf2baa7dbdc
def hover_scale(
...
# %% ../../nbs/utilities/transforms.ipynb #82989fdb-3697-4c31-9002-d4f6e98d5a0c
def flip_card_3d(
...
# %% ../../nbs/utilities/transforms.ipynb #3ae7355e-075a-4538-a846-257238ebb910
...
# %% ../../nbs/utilities/transforms.ipynb #2e169f91-cdb2-4edb-8d35-5162f594504b
