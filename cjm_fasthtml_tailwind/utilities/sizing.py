...
# %% ../../nbs/utilities/sizing.ipynb #1effc534-e03c-4778-822c-b85d52439b79
...
# %% ../../nbs/utilities/sizing.ipynb #0b9e9974-4fdf-42c4-9a9e-eda6d3203a1c
w = ScaledFactory("w", SIZE_CONFIG, "Width utilities for setting element width") # The width factory

# %% ../../nbs/utilities/sizing.ipynb #723ebfbf-6cb5-4b9b-b7e6-9f763d87aa0b
...
# %% ../../nbs/utilities/sizing.ipynb #df536caa-e426-41ec-aa73-c32380cacc75
...
# %% ../../nbs/utilities/sizing.ipynb #fc183a15-e99f-467e-ba13-d4a8b8d524a0
...
# %% ../../nbs/utilities/sizing.ipynb #a26a23e9-2ac8-4230-9296-0f26977f227c
...
# %% ../../nbs/utilities/sizing.ipynb #c42c1a1a-e00e-4c7b-a040-ee52a6edad45
h = ScaledFactory("h", SIZE_CONFIG, "Height utilities for setting element height") # The height factory

# %% ../../nbs/utilities/sizing.ipynb #f8404bdc-e218-448d-af8a-4350dce73abf
...
# %% ../../nbs/utilities/sizing.ipynb #29b2423a-181b-4935-9819-1f209be6b3ed
...
# %% ../../nbs/utilities/sizing.ipynb #a6fd11a8-bbe8-4f40-8cb8-128bbc22f923
min_w = ScaledFactory("min-w", SIZE_CONFIG, "Minimum width utilities for setting minimum element width") # The min-width factory

# %% ../../nbs/utilities/sizing.ipynb #f0905fd0-a68e-4718-8121-1777c0d328f8
...
# %% ../../nbs/utilities/sizing.ipynb #6e83216e-b868-474d-b01a-4357c6317618
max_w = ScaledFactory("max-w", SIZE_CONFIG, "Maximum width utilities for setting maximum element width") # The max-width factory

# %% ../../nbs/utilities/sizing.ipynb #3f653473-deb1-4475-a6e7-e834a91399dc
...
# %% ../../nbs/utilities/sizing.ipynb #l5an34x6hqm
# Container utility
...
# %% ../../nbs/utilities/sizing.ipynb #d0388de5-eb4a-4d57-ad24-b5664e026307
...
# %% ../../nbs/utilities/sizing.ipynb #2416fb9d-204a-4a07-b950-8e90530c2381
min_h = ScaledFactory("min-h", SIZE_CONFIG, "Minimum height utilities for setting minimum element height") # The min-height factory

# %% ../../nbs/utilities/sizing.ipynb #49d3dabd-0526-4bc5-8ad2-a0125026323a
...
# %% ../../nbs/utilities/sizing.ipynb #poa1uri5ag9
...
# %% ../../nbs/utilities/sizing.ipynb #ed12ca92-fbd0-4afd-a267-99229ed8aa78
...
# %% ../../nbs/utilities/sizing.ipynb #a0tt6ly9ehg
...
# %% ../../nbs/utilities/sizing.ipynb #18b10029-c177-4489-bd4e-1e43aabe25c7
def size(
...
# %% ../../nbs/utilities/sizing.ipynb #6ac8cdc3-77f4-4bae-9777-e26549adaadf
def square(
